...
export function buildArticleFactoryPrompts(input) {
  return {
    ...
    userPrompt: [
      ...
      '{"articles":[{"slug":"string","title":"string","excerpt":"string","meta_title":"string","meta_description":"string","keywords":["a","b","c","d","e"],"author":{"name":"AI Threat Brief Research","role":"Editorial Team","profileUrl":"https://...","bio":"optional"},"intro":["paragraph"],"sections":[{"heading":"string","paragraphs":["paragraph","paragraph"]}],"key_takeaways":["item"],"primarySources":[{"url":"https://...","title":"string","date":"optional","excerpt":"optional"}]}]}',
      'Requirements:',
      '- Exactly 2 articles.',
      '- Each article should render to roughly 950-1200 words after markdown rendering.',
      '- The author object is required on every article. Use the byline AI Threat Brief Research with the role Editorial Team unless explicitly instructed otherwise.',
