...
export const VERIFIED_PAGE_METADATA = Object.freeze([
  ...
  },
  {
    ...
    canonicalPath: '/pro',
    ogDescription:
      'Overview of AI Threat Brief Pro and how the member-content path complements the flagship readiness review.',
  },
  {
    path: '/upgrade',
    canonicalPath: '/upgrade',
    ogDescription:
      'Continue to the current AI Threat Brief Pro access flow.',
  },
  {
    path: '/tools',
    canonicalPath: '/tools',
  ...
  },
  {
    ...
    ogDescription:
      'Public operational status for AI Threat Brief: pinned main baseline, deployment context, and release verification signals.',
  },
  {
    path: '/terms',
    canonicalPath: '/terms',
